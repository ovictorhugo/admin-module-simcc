...
export function ItemDashboard(props:Props) {
    ...
    return(
        <Link to={props.url} className="h-full min-h-full">
        <Alert className="h-full min-h-full dark:hover:bg-neutral-900 hover:bg-gray-100 transition-all w-full items-end flex flex-col justify-between">
