...
export function Search() {
  ...
  return (
    <div className={`bottom-0 ${movel ? "-mt-3" : "mt-4"}  mb-2  w-full flex flex-col max-sm:flex  max-sm:flex-row`}>
          ...
          <div className="flex gap-4">
            ...
            <Alert className="h-14 p-2 flex items-center justify-between w-full">
              <div className="flex items-center gap-1 flex-1">
                <MagnifyingGlass size={movel ? 15 : 20} className={`whitespace-nowrap w-10 ${movel && "w-6"}`} />
