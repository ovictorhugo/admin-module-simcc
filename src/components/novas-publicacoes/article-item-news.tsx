...
export function ArticleItem(props:Articles) {
  ...
  const { onOpen } = useModal();
    ...
    return(
        <div className="flex cursor-pointer h-[450px] w-[350px] " onClick={() => onOpen('articles-modal', {doi:doi, qualis:props.qualis, title:props.title, year:props.year, jif:props.jif, lattes_10_id:props.lattes_10_id, researcher_id:props.researcher_id, magazine:props.name_periodical})}>
