...
const handlePesquisadoresUpdate = () => {
    // Mapear os pesquisadores selecionados e formatar os dados
    ...
    // Chamar a função de callback com os dados formatados
    config.onPesquisadoresUpdate(formattedPesquisadores);
};
// Chamada da função para atualizar os pesquisadores quando houver mudanças
useEffect(() => {
    handlePesquisadoresUpdate();
