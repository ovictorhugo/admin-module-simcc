  ...
  return (
    <>
      <div className="mb-[150px]">
        <div className={`flex gap-6 w-full ${movel ? "flex-col" : "flex-row"}`}>
        ...
        <Accordion type="single" collapsible defaultValue="item-1">
          <AccordionItem value="item-1" >
            <div className="flex mb-2">
              <HeaderResultTypeHome title="Gráfico de orientações em andamento e concluídas " icon={<ChartBar size={24} className="text-gray-400 text-left" />}>
