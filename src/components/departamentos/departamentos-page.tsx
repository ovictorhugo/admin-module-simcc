...
export function DepartamentPage() {
    ...
    const urlPatrimonioInsert = `${urlGeral}departamentos`
 ...
 <div className="bg-cover bg-bottom bg-no-repeat px-4 md:px-8" style={{ backgroundImage: `url(${bg_popup})` }}>
              ...
              <div className="grid grid-cols-1">
                <ScrollArea>
                  {filteredTotal.map((item) => (
                    <Alert onClick={() => setTotalSelecionado(item)} className="w-[300px] cursor-pointer p-8 flex items-center justify-center">
