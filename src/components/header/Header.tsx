...
export function Header() {
  ...
  return (
    <div className={'top-0 absolut w-full '}>
      <header className={`h-[40px] my-2  px-4  flex justify-between dark:bg-black items-center`}>
        {
          !movel
          &&
        ...
        <div className={`flex gap-2 items-center justify-center ${movel && "w-full justify-between"}`}>
            ...
            {!loggedIn && (
              <Link to={'/signIn'}>
                <Button variant='ghost' size="sm" className="h-8 px-2" >
                  ...
                  <span className={`${movel && "text-[0.7rem]"}`}>Fazer login</span>
                </Button></Link>
            )}
            {!loggedIn && (
              <Link to={'/signUp'}>
                <Button size="sm" className="h-8 px-2">
                  ...
                  <span className={`${movel && "text-[0.7rem]"}`}>Criar conta</span>
                </Button></Link>
            )}
          </div>
          ...
          <div className={`flex items-center ${movel ? " gap-1" : "gap-2"}`}>
            <ModeToggle />
            {version && (
              <DropdownMenu>
