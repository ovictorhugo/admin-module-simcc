...
export function HomepageProgram(props: Props) {
  ...
  const urlTermPesquisadores = `${urlGeral}researcherName?name=&graduate_program_id=${type_search}`
    ...
    <main className="h-full w-full flex flex-col">
      <div className="flex justify-between items-center py-12">
        <div className="flex  gap-6">
          ...
          <div>
            <p className={`max-w-[750px] mt-0 mb-2 text-lg font-light text-foreground ${movel && "-mt-7"}`}>
            ...
            <h1
              className={`
                ${movel ? "text-3xl" : "text-4xl"} max-w-[800px]
                font-bold leading-tight tracking-tighter
                md:text-4xl lg:leading-[1.1] md:block
              `}
            >
              {props.program.name}
            </h1>
