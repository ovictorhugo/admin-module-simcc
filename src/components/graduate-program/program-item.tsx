...
export function ProgramItem(props: GraduateProgram) {
  ...
  return (
    <div className="flex items-center z-[99] relative w-full" onClick={() => handlePesquisaFinal()} >
      <div className="flex w-full" >
        ...
        >
          ...
          <div className="line-clamp-2 text-xs flex text-muted-foreground flex-wrap gap-4">
